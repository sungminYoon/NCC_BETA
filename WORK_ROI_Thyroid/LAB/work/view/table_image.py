...
class TableImage:
    table_list = None       # 테이블 뷰에 보여질 image 리스트 입니다.
    top_widget = None       # 최상단 cell 객체 입니다.
    top_layout = None       # 최상단 cell 의 layout 입니다.
    group_layout = None     # 셀 안의 객체들 입니다.
    call_back = None        # 윈도우 뷰에 선택한 Table mounting data 를 보냅 니다.
    ...
    def click_event(self, num):
        ...
        # 실제 list 가져 올때는 0부터 가져 오기 때문에 -1
