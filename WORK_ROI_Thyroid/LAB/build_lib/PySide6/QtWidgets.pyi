...
class QFileDialog(PySide6.QtWidgets.QDialog):
    ...
    @staticmethod
    def getOpenFileName(parent:Optional[PySide6.QtWidgets.QWidget]=..., caption:str=..., dir:str=..., filter:str=..., options:PySide6.QtWidgets.QFileDialog.Options=...) -> Tuple[str, str]: ...
    @staticmethod
    def getOpenFileNames(parent:Optional[PySide6.QtWidgets.QWidget]=..., caption:str=..., dir:str=..., filter:str=..., options:PySide6.QtWidgets.QFileDialog.Options=...) -> Tuple[List, str]: ...
    @staticmethod
    def getOpenFileUrl(parent:Optional[PySide6.QtWidgets.QWidget]=..., caption:str=..., dir:Union[PySide6.QtCore.QUrl, str]=..., filter:str=..., options:PySide6.QtWidgets.QFileDialog.Options=..., supportedSchemes:Sequence[str]=...) -> Tuple[PySide6.QtCore.QUrl, str]: ...
    @staticmethod
    def getOpenFileUrls(parent:Optional[PySide6.QtWidgets.QWidget]=..., caption:str=..., dir:Union[PySide6.QtCore.QUrl, str]=..., filter:str=..., options:PySide6.QtWidgets.QFileDialog.Options=..., supportedSchemes:Sequence[str]=...) -> Tuple[List, str]: ...
    @staticmethod
    def getSaveFileName(parent:Optional[PySide6.QtWidgets.QWidget]=..., caption:str=..., dir:str=..., filter:str=..., options:PySide6.QtWidgets.QFileDialog.Options=...) -> Tuple[str, str]: ...
    @staticmethod
    def getSaveFileUrl(parent:Optional[PySide6.QtWidgets.QWidget]=..., caption:str=..., dir:Union[PySide6.QtCore.QUrl, str]=..., filter:str=..., options:PySide6.QtWidgets.QFileDialog.Options=..., supportedSchemes:Sequence[str]=...) -> Tuple[PySide6.QtCore.QUrl, str]: ...
...
class QFontDialog(PySide6.QtWidgets.QDialog):
    ...
    @typing.overload
    @staticmethod
    def getFont(initial:Union[PySide6.QtGui.QFont, Sequence], parent:Optional[PySide6.QtWidgets.QWidget]=..., title:str=..., options:PySide6.QtWidgets.QFontDialog.FontDialogOptions=...) -> Tuple[bool, PySide6.QtGui.QFont]: ...
    @typing.overload
    @staticmethod
...
class QGraphicsItem(Shiboken.Object):
    ...
    def isBlockedByModalPanel(self, blockingPanel:Optional[PySide6.QtWidgets.QGraphicsItem]=...) -> bool: ...
...
class QGraphicsView(PySide6.QtWidgets.QAbstractScrollArea):
    ...
    def drawBackground(self, painter:PySide6.QtGui.QPainter, rect:Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]) -> None: ...
    def drawForeground(self, painter:PySide6.QtGui.QPainter, rect:Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]) -> None: ...
    def drawItems(self, painter:PySide6.QtGui.QPainter, numItems:int, items:Sequence[PySide6.QtWidgets.QGraphicsItem], options:Sequence[PySide6.QtWidgets.QStyleOptionGraphicsItem]) -> None: ...
    def dropEvent(self, event:PySide6.QtGui.QDropEvent) -> None: ...
    @typing.overload
...
class QToolBar(PySide6.QtWidgets.QWidget):
    ...
    def addAction(self, icon:Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap], text:str) -> PySide6.QtGui.QAction: ...
    @typing.overload
    def addAction(self, icon:Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap], text:str, receiver:PySide6.QtCore.QObject, member:bytes) -> PySide6.QtGui.QAction: ...
    @typing.overload
    def addAction(self, text:str) -> PySide6.QtGui.QAction: ...
    @typing.overload
    def addAction(self, text:str, receiver:PySide6.QtCore.QObject, member:bytes) -> PySide6.QtGui.QAction: ...
...
class QWidget(PySide6.QtCore.QObject, PySide6.QtGui.QPaintDevice):
    ...
    def nativeEvent(self, eventType:Union[PySide6.QtCore.QByteArray, bytes], message:int) -> Tuple[bool, int]: ...
