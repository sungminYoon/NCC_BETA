...
class Property(object):
    ...
    def deleter(self, func:Callable) -> None: ...
    def getter(self, func:Callable) -> None: ...
    def read(self, func:Callable) -> None: ...
    def setter(self, func:Callable) -> None: ...
...
class QAbstractNativeEventFilter(Shiboken.Object):
    ...
    def nativeEventFilter(self, eventType:Union[PySide6.QtCore.QByteArray, bytes], message:int) -> Tuple[bool, int]: ...
...
class QLineF(Shiboken.Object):
    ...
    def intersects(self, l:Union[PySide6.QtCore.QLineF, PySide6.QtCore.QLine], intersectionPoint:Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, NoneType]=...) -> PySide6.QtCore.QLineF.IntersectionType: ...
    def isNull(self) -> bool: ...
...
class QObject(Shiboken.Object):
    ...
    @typing.overload
    def findChildren(self, arg__1:type, arg__2:Union[PySide6.QtCore.QRegularExpression, str]) -> Iterable: ...
